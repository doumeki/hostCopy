...
local function y(o,i,t)
if a.contains(t,o)then
...
local n=i.sysauth_authenticator
local h,t,a,d,s
...
function _find_eligible_node(t,i,e,o,s)
...
a.contains(o,t.target.type)))
then
return i
end
end
function _find_node(o,a)
local e={unpack(context.path)}
local t=table.concat(e,".")
local t=context.treecache[t]
e=_find_eligible_node(t,e,o,a)
if e then
dispatch(e)
else
...
local e=function(e,...)
require"luci.template".render("view",{view=e.view})
end
function view(t)
return{type="view",view=t,target=e}
end
local function d(n,...)
